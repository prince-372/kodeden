...
const Header = () => {
  return (
    <>
      <div id="Home" className=" container pt-73 pt-5  position-relative ">
      ...
      <div className=" position-fixed icon-bar top-40 d-flex flex-column align-items-center justify-content-center gap-md-2 ">
        <Twiter/>
        <Insta/>
        <Taligram/>
        <Inlinked/>
